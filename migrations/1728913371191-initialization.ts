...
export class Initialization1728913371191 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "perimeters" ("id" character varying(24) NOT NULL, "organization_id" character varying(24) NOT NULL, "type" "public"."perimeters_type_enum" NOT NULL, "code" text NOT NULL, CONSTRAINT "PK_812f0b99b15bb4dbab4e807b24d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "revisions" ("id" character varying(24) NOT NULL, "source_id" character varying(24) NOT NULL, "harvest_id" character varying(24) NOT NULL, "file_id" character varying(24), "data_hash" text, "code_commune" text, "update_status" "public"."update_status_revision", "update_rejection_reason" text, "publication" jsonb, "validation" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4aa9ee2c71c50508c3c501573c9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "organizations" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" character varying(24) NOT NULL, "name" text NOT NULL, "page" text, "logo" text, CONSTRAINT "PK_6b031fcd0863e3f6b44230163f9" PRIMARY KEY ("id"))`);
