...
export class Initialization1728997793201 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "perimeters" ("id" character varying(24) NOT NULL, "organization_id" character varying(24) NOT NULL, "type" "public"."perimeters_type_enum" NOT NULL, "code" text NOT NULL, CONSTRAINT "PK_812f0b99b15bb4dbab4e807b24d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_perimeters_organization_id" ON "perimeters" ("organization_id") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."update_status_revision" AS ENUM('rejected', 'updated', 'unchanged')`,
    );
    await queryRunner.query(
      `CREATE TABLE "revisions" ("id" character varying(24) NOT NULL, "source_id" character varying(24) NOT NULL, "harvest_id" character varying(24) NOT NULL, "file_id" character varying(24), "data_hash" text, "code_commune" text, "update_status" "public"."update_status_revision", "update_rejection_reason" text, "publication" jsonb, "validation" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4aa9ee2c71c50508c3c501573c9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "harvests" ("id" character varying(24) NOT NULL, "source_id" character varying(24) NOT NULL, "file_id" character varying(24), "file_hash" text, "data_hash" text, "status" "public"."harvests_status_enum" NOT NULL DEFAULT 'active', "update_status" "public"."update_status_harvest", "update_rejection_reason" text, "error" text, "started_at" TIMESTAMP, "finished_at" TIMESTAMP, CONSTRAINT "PK_fb748ae28bc0000875b1949a0a6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "organizations" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" character varying(24) NOT NULL, "name" text NOT NULL, "page" text, "logo" text, CONSTRAINT "PK_6b031fcd0863e3f6b44230163f9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d5bc12ae4a6da1f7a555163e6d" ON "organizations" ("deleted_at") `,
    );
    await queryRunner.query(
      `ALTER TABLE "perimeters" ADD CONSTRAINT "FK_9cc54d5e41f6ce6ca061490f1f2" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "perimeters" DROP CONSTRAINT "FK_9cc54d5e41f6ce6ca061490f1f2"`,
    );
    await queryRunner.query(
