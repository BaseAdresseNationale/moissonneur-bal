...
function extractGeoJSONFeatures(gdalPath, options) {
  gdal.config.set('SHAPE_ENCODING', options.encoding) // If options.encoding is undefined, the config setting is unset
