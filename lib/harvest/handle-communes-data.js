...
async function handleCommuneData({codeCommune, currentRevision, sourceId, harvestId, rows, organizationName}) {
...
async function handleCommunesData({sourceId, harvestId, rows, organizationName}) {
